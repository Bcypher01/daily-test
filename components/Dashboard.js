        ...
        <div className="grid py-4 place-items-center">
          <div className="flex space-x-2">
            ...
            >
              <g opacity="0.4">
                <path
                  d="M9.5 14L5 9.5L9.5 5"
                  stroke="#262626"
                  stroke-width="2"
                />
                <path
                  d="M14 14L9.5 9.5L14 5"
                  stroke="#262626"
                  stroke-width="2"
                />
              </g>
            </svg>
            <span className="border border-neutral-400 rounded-md text-center pt-1 w-[35px] h-[35px]">
              1
            </span>
            <span className="border bg-blue-600 text-white border-neutral-400 rounded-md text-center pt-1 w-[35px] h-[35px]">
              2
            </span>
            <span className="border border-neutral-400 rounded-md text-center pt-1 w-[35px] h-[35px]">
              3
